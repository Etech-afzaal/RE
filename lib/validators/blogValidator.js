...
export const BLOG_CONTENT_MAX = 20000;
...
export function validateBlogInput(input = {}, { requireContent = false } = {}) {
  ...
  // Content is free-form multiline text; reject HTML/script fragments to
  ...
  if (!content) {
    ...
    if (hasHtmlOrScript(content)) {
      return { ok: false, error: "Please remove HTML or script tags from the content.", field: "content" };
    }
