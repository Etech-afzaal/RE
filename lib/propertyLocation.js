 ...
 *
 * DB stores city / area / phase / address in property_data.location; the API
 * projects these fields for existing consumers. Cards and other compact
 ...
 * the structured JSON fields untouched.
 *
 * @param {object} body
 ...
 * Prefers structured JSON projections; falls back to parsing legacy `location`.
 *
 * @param {object} property
