...
test("saved empty JSON amenities and insights do not show generated fallback sections", async () => {
  const normalized = formData.normalizePropertyData({ propertyDetails: { amenities: [] }, insights: { why_this_home: [] } }, "sale", "house");
  ...
  assert.deepEqual(mapping.publicPropertyInsight({ ...property, why_this_home: ["Existing column"] }, "why_this_home"), ["Existing column"]);
});
