...
function ffmpegBin() {
  return process.env.FFMPEG_PATH || ffmpegStatic;
}

function ffprobeBin() {
  return process.env.FFPROBE_PATH || ffprobeStatic.path;
}

console.info("Property video FFmpeg executable:", ffmpegBin());
console.info("Property video FFprobe executable:", ffprobeBin());
