 ...
 *
 * @param {{ agent_id?: number, property_id?: number, name: string, email: string, phone?: string, message: string, page_url?: string }} input
 */
export async function createCustomerInquiry(input) {
  ...
  const { name, email, phone, message, page_url } = validated.data;
