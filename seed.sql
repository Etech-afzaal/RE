...
SELECT id, '10 Marla House for Sale in DHA Phase 6',
  ...
  10, 'marla', 42500000, 'DHA Phase 6, Lahore', 'approved'
FROM users WHERE estate_name = 'dha-homes';
...
SELECT id, '5 Marla House for Sale in Bahria Town Sector C',
  ...
  5, 'marla', 18500000, 'Bahria Town, Lahore', 'approved'
FROM users WHERE estate_name = 'bahria-estate';
...
SELECT id, '1 Kanal Luxury House for Sale in Gulberg III',
  ...
  1, 'kanal', 95000000, 'Gulberg III, Lahore', 'approved'
FROM users WHERE estate_name = 'gulberg-props';
...
SELECT id, '7 Marla Brand New House for Sale in Johar Town',
  ...
  7, 'marla', 26800000, 'Johar Town, Lahore', 'approved'
FROM users WHERE estate_name = 'johar-living';
...
SELECT id, '10 Marla Double Storey for Sale in Model Town',
  ...
  10, 'marla', 52000000, 'Model Town, Lahore', 'approved'
FROM users WHERE estate_name = 'model-town-re';
...
SELECT id, '1 Kanal Bungalow for Sale in Lahore Cantt',
  ...
  1, 'kanal', 78000000, 'Lahore Cantt', 'approved'
FROM users WHERE estate_name = 'cantt-homes';
...
SELECT id, '5 Marla Modern House for Sale in Valencia Town',
  ...
  5, 'marla', 17200000, 'Valencia Town, Lahore', 'approved'
FROM users WHERE estate_name = 'valencia-re';
...
SELECT id, '8 Marla Designer House for Sale in Lake City',
  ...
  8, 'marla', 29500000, 'Lake City, Lahore', 'approved'
FROM users WHERE estate_name = 'lake-city-re';
...
SELECT id, '3 Bed Apartment for Rent in DHA Phase 5',
  ...
  8, 'marla', 145000, 'DHA Phase 5, Lahore', 'approved'
FROM users WHERE estate_name = 'dha-homes';
...
SELECT id, 'Fully Furnished House for Rent in Bahria Town',
  ...
  5, 'marla', 110000, 'Bahria Town, Lahore', 'approved'
FROM users WHERE estate_name = 'bahria-estate';
...
SELECT id, '2 Bed Flat for Rent near MM Alam Road',
  ...
  900, 'sqft', 95000, 'Gulberg III, Lahore', 'approved'
FROM users WHERE estate_name = 'gulberg-props';
...
SELECT id, 'Upper Portion for Rent in Johar Town Block H',
  ...
  5, 'marla', 75000, 'Johar Town, Lahore', 'approved'
FROM users WHERE estate_name = 'johar-living';
...
SELECT id, '5 Marla House for Rent in Model Town',
  ...
  5, 'marla', 125000, 'Model Town, Lahore', 'approved'
FROM users WHERE estate_name = 'model-town-re';
...
SELECT id, 'Studio Apartment for Rent in Lahore Cantt',
  ...
  450, 'sqft', 45000, 'Lahore Cantt', 'approved'
FROM users WHERE estate_name = 'cantt-homes';
...
SELECT id, '10 Marla Residential Plot in Bahria Town',
  ...
  10, 'marla', 15500000, 'Bahria Town, Lahore', 'approved'
FROM users WHERE estate_name = 'bahria-estate';
...
SELECT id, '1 Kanal Corner Plot in DHA Phase 7',
  ...
  1, 'kanal', 62000000, 'DHA Phase 7, Lahore', 'approved'
FROM users WHERE estate_name = 'dha-homes';
...
SELECT id, '5 Marla Plot for Sale in Lake City',
  ...
  5, 'marla', 6800000, 'Lake City, Lahore', 'approved'
FROM users WHERE estate_name = 'lake-city-re';
...
SELECT id, '10 Marla Commercial Plot in Valencia Town',
  ...
  10, 'marla', 28500000, 'Valencia Town, Lahore', 'approved'
FROM users WHERE estate_name = 'valencia-re';
...
SELECT id, '7 Marla Residential Plot in Johar Town',
  ...
  7, 'marla', 21000000, 'Johar Town, Lahore', 'approved'
FROM users WHERE estate_name = 'johar-living';
